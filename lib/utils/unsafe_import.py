...
def model_from_hf_path(path, use_cuda_graph=True, use_flash_attn=True):
    ...
    if "70" in path:
        revision = "4f6cb44d1c12cc4f9a325d0cca3652e41b32a5ae" # "d0157ef7dbd7a0ae85529610bcce7c400f7fd567"
    elif "13" in path:
        revision = "8bd06ae4a0cfff0f29ef2e936e5bfc4b28407e63" # "e1bf05f88ce56c85a58d9a21150102aef85a2ee0"
    elif "7" in path:
        revision = "22c75336223c885adf2cc95db52958cd6266c5bf" # "cb7ab7234aa14e0f85e95bf740af5b27fffee24d"
